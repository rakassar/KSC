...
public class dbsqlconnection {
        ...
        Connection conn = DriverManager.getConnection("jdbc:sqlserver//192.168.0.13//MSSQLSERVER2019:1433;user=crmnext;password=abc123;database=ksc_sa");
        System.out.println("Database sucessfully connected.");
  
        Statement sta = conn.createStatement();
        String Sql = "select  *  from leads where LeadID=1";
