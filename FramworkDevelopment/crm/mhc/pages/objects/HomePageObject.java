...
public class HomePageObject extends LoginPageObject {
	...
	//---create lead
	 ...
	 public static WebElement clk_homewidget ;
     
     @FindBy(xpath="//span[normalize-space()='ollection Search']")
	 public static WebElement clk_ClickOnCollectionSearchWidget ;
    
     @FindBy(xpath="//span[normalize-space()='ollection Assignment']")
	 public static WebElement clk_ClickOnCollectionAssignmentWidget ;

   //Fill the all text box type info//
   @FindBy(xpath="//span[normalize-space()='Search']")
   public static WebElement Clk_searchButton;

     
   @FindBy(xpath="//span[normalize-space()='Next']")
   public static WebElement Clk_nextbutton;
